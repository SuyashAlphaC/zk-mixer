...
contract MixerTest is Test {
    ...
    function _getProof(bytes32[] memory leaves, bytes32 _nullifier, bytes32 _secret, address _recipient) public returns(bytes memory _proof) {
    ...
    function testWithdraw() public {
        ...
        bytes memory _proof = _getProof(leaves, _nullifier, _secret, receiver);
        console.log("Proof : ");
